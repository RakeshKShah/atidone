...
TITLE_ONE="Buy milk ${CASE_SUFFIX}"
TITLE_TWO="Read book ${CASE_SUFFIX}"
OTHER_EMAIL="codevalid-other-user-${CASE_SUFFIX}@example.com"
OTHER_PASSWORD="CodevalidOther-${CASE_SUFFIX}!"
OTHER_TITLE="Other user secret ${CASE_SUFFIX}"
...
# Given
echo "STEP: Given — create two authenticated users and seed isolated todos via public API"
