...
CASE_SUFFIX="$(date +%s)-$$"
TEST_ID="create_todo_missing_title_rejected"
...
echo "STEP: When — POST create todo request without title field"
...
echo "STEP: Then — request is rejected as invalid"
...
echo "CODEVALID_TEST_ASSERTION_OK:create_todo_missing_title_rejected"
